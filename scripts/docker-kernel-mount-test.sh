...
docker run --rm --privileged \
    ...
    -e SLATEFS_NBD_CHUNK_SIZE -e SLATEFS_NBD_BLOCK_SIZE \
    -e SLATEFS_NBD_PORT -e SLATEFS_NBD_ADMIN_PORT -e SLATEFS_NBD_METRICS_PORT \
    -e SLATEFS_NBD_CLIENT_TIMEOUT \
    ...
    -e SLATEFS_NBD_FAILOVER_TENANT -e SLATEFS_NBD_FAILOVER_VOLUME \
    -e SLATEFS_NBD_FAILOVER_SIZE_BYTES -e SLATEFS_NBD_FAILOVER_CHUNK_SIZE \
    -e SLATEFS_NBD_FAILOVER_BLOCK_SIZE -e SLATEFS_NBD_FAILOVER_PORT \
    -e SLATEFS_NBD_FAILOVER_PRIMARY_ADMIN_PORT -e SLATEFS_NBD_FAILOVER_TAKEOVER_ADMIN_PORT \
    -e SLATEFS_NBD_FAILOVER_PRIMARY_METRICS_PORT -e SLATEFS_NBD_FAILOVER_TAKEOVER_METRICS_PORT \
    -e SLATEFS_NBD_FAILOVER_CLIENT_TIMEOUT -e SLATEFS_NBD_FAILOVER_LOAD_MODE \
    -e SLATEFS_NBD_FAILOVER_LOAD_WARMUP -e SLATEFS_NBD_FAILOVER_MAX_SECONDS \
    -e SLATEFS_NBD_FAILOVER_OP_TIMEOUT -e SLATEFS_NBD_FAILOVER_LONG_TIMEOUT \
    -e SLATEFS_NBD_FAILOVER_FIO_RUNTIME -e SLATEFS_NBD_FAILOVER_FIO_SIZE \
    -e SLATEFS_NBD_FAILOVER_FIO_JOBS -e SLATEFS_NBD_FAILOVER_FIO_BS \
    -e SLATEFS_NBD_FAILOVER_FIO_RW -e SLATEFS_NBD_FAILOVER_PERSIST_PROBE \
    -e SLATEFS_NBD_FAILOVER_PERSIST_REQUIRED -e SLATEFS_NBD_FAILOVER_DEVICES \
