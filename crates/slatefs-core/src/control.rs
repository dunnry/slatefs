...
pub enum AuditAction {
    ...
    VersionGc,
    VersionPurge,
    VersionRepositoryExport,
    VersionRepositoryImport,
    VersionSyncExport,
    VersionSyncApply,
    VersionRetentionSet,
    VersionEnable,
...
impl AuditAction {
    pub fn parse(value: &str) -> Option<Self> {
        Some(match value {
            ...
            "VersionCherryPick" => Self::VersionCherryPick,
            "VersionAttest" => Self::VersionAttest,
            "VersionRestore" => Self::VersionRestore,
            "VersionGc" => Self::VersionGc,
            "VersionPurge" => Self::VersionPurge,
            "VersionRepositoryExport" => Self::VersionRepositoryExport,
            "VersionRepositoryImport" => Self::VersionRepositoryImport,
            "VersionSyncExport" => Self::VersionSyncExport,
            "VersionSyncApply" => Self::VersionSyncApply,
