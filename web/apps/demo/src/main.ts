...
const icons = {
  ...
  versions: icon(
    `<circle cx="6" cy="6" r="2.4"/><circle cx="6" cy="18" r="2.4"/><circle cx="18" cy="12" r="2.4"/><path d="M6 8.4v7.2"/><path d="M8 7l7.7 4"/>`,
  ),
  snapshots: icon(
    `<circle cx="12" cy="12" r="8.2"/><circle cx="12" cy="12" r="3.4"/>`,
  ),
  branches: icon(
    `<circle cx="6" cy="5.5" r="2.2"/><circle cx="6" cy="18.5" r="2.2"/><circle cx="18" cy="7.5" r="2.2"/><path d="M6 7.7v8.6"/><path d="M18 9.7c0 4.5-6 2.7-9.4 6.1"/>`,
  ),
